...
function preload() {
  ...
  //Descomenta el código para caragar DoodleNet
...
function gotResult(error, results) {
  ...
  //Descomenta el código para Precisión en porcentaje
  //document.getElementById('confidence').innerHTML = 'Precisión: '  * 100;
  //document.getElementById('confidence').innerHTML = 'Precisión: ' + results[0].confidence * 100;
